<template>
    <li>
        <img src="../assets/back.svg" width="30" alt="back_button" @click="changeCurrentNumberofOption(mathSymbol=false)">
       {{alias}}
        <img src="../assets/back.svg" width="30" alt="forward-button" class="option-forward-button" @click="changeCurrentNumberofOption(mathSymbol=true)" >
